	 ...
	 if ( $result1->num_rows > 0 ) {
		foreach ( $result1 as $row ) {
			...
			<li style="background-color: antiquewhite;">
				 <span><?php echo($row["name"])?> buying for <strong><a href="<?=$_SESSION["directory"]?>farmer/cropdetail.php?id=<?php echo $row['VID'] ?>" onClick="removenoti(<?=$nid?>)"> <?php echo($row["vname"])?>  </a></strong> </span>

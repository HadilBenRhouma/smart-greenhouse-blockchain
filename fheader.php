                ...
                <div class="navbar navbar-default mega-menu" role="navigation" style="background-color: white;">
                    <div class="container">
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle" data-toggle="extend" data-target=".cd-navbar-extend">
                        ...
                        <div class="extend navbar-extend cd-navbar-extend">
                            <!-- Nav Menu -->
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                       ...
                                       <li><a href="<?=$_SESSION["directory"]?>farmer/measures.php">measures</a></li>
                                        <li><a href="<?=$_SESSION["directory"]?>farmer/weather.php">weather</a></li>
                                    </div>
                                    </ul>

                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                   ...
                                   <?php   if((isset($_SESSION["isLogedIn"]) && $_SESSION["isLogedIn"]==true) &&(isset($_SESSION["role"]) && $_SESSION["role"]=="1")){ ?>  
                                     ...
                                     <?php  }else if ((isset($_SESSION["isLogedIn"]) && $_SESSION["isLogedIn"]==true) &&(isset($_SESSION["role"]) && $_SESSION["role"]=="0")){ ?> 
	 								  
                                       <a href="<?=$_SESSION["directory"]?>index.php">Home</a> 
                                    <?php  } else { ?> 
	 								  
                                       <a href="<?=$_SESSION["directory"]?>indexhome.php">Home</a>  </li>
                                ...
                                <?php
									if((isset($_SESSION["isLogedIn"]) && $_SESSION["isLogedIn"]==true) &&(isset($_SESSION["role"]) && $_SESSION["role"]!="1")){ ?>
                                <li class="btn-product">
                                    <a href="<?=$_SESSION["directory"]?>customer/veggie.php"  >
                                      Promotions
                                    </a>
                                ...
                                <?php
									if((isset($_SESSION["isLogedIn"]) && $_SESSION["isLogedIn"]==true) &&(isset($_SESSION["role"]) && $_SESSION["role"]=="1")){ ?>
                                <li class="btn-product">
                                    <a href="<?=$_SESSION["directory"]?>admin/veggie.php"  >
                                      Promotions
                                    </a>
